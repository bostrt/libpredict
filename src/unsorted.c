...
double ThetaG_JD(double jd)
{
	...
	GMST=Modulus(GMST+SECONDS_PER_DAY*EARTH_ROTATIONS_PER_SIDERIAL_DAY*UT,SECONDS_PER_DAY);
...
void Calculate_LatLonAlt(double time, const double pos[3],  geodetic_t *geodetic)
{
	...
	do
	{
		...
		geodetic->lat=AcTan(pos[2]+EARTH_RADIUS_KM_WGS84*c*e2*sin(phi),r);
