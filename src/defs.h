 ...
 *
 * The constants might originally be defined in Hujsak (1979) and/or Hujsak and
 * Hoots (1977), but this is unavailable on the Internet. Reiterated in F. R.
 * Hoots, P. W. Schumacher and R. A. Glober, "A HISTORY OF ANALYTICAL ORBIT
 * MODELING IN THE UNITED STATES SPACE SURVEILLANCE SYSTEM", 2004. Page numbers
 * below refer to this article.
 **/
